...
if ($params->get('displayType') == 'modal')
{
    ...
    echo '<div class="sourcecoast sclogin-modal-links sclogin"><span class="at-icon-assignment-ind" style="color: #ff8706;">&nbsp;</span><a ' . $loginClass . ' href="#login-modal" role="button" data-toggle="' . $modalName . '">' . JText::_('MOD_SCLOGIN_LOGIN') . '</a>';

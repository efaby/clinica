...
class JFormFieldavatarcaroucelselector extends JFormField
{
	public $type = 'avatarcaroucelselector';

	protected function getInput()
	{
		$html 		= '';
		$options 	= array();
		$base 		= JPATH_ROOT.DIRECTORY_SEPARATOR.'modules'.DIRECTORY_SEPARATOR.AT_NAME.DIRECTORY_SEPARATOR.'tmpl'.DIRECTORY_SEPARATOR.'caroucel';

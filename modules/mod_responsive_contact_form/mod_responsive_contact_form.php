...
//$document->addScriptDeclaration('(function () { $("input,select,textarea").not("[type=submit]").jqBootstrapValidation(); } )(jQuery);');
	  ...
	  <fieldset>
		...
		<!-- Name Field -->
		  <div class="control-group">
			<label class="control-label at-icon-assignment-ind" for="inputName"><?php //echo $params->get('ffield_name'); ?></label>
			<div class="controls">
		 ...
		 <!-- E-mail Field -->
		  ...
		  <div class="control-group">
			<label class="control-label at-icon-email" for="inputEmail"><?php //echo $params->get('sfield_name'); ?></label>
			<div class="controls">
		  ...
		  <!-- Phone Field -->
		  <div class="control-group">
			<label class="control-label at-icon-smartphone" for="inputPhone"><?php //echo $params->get('tfield_name'); ?></label>
			<div class="controls">
		 ...
		 <!-- Subject Field -->
		  <div class="control-group">
			<label class="control-label at-icon-calendar" for="selectSubject"><?php //echo $params->get('fofield_name'); ?></label>
			<div class="controls">
		 ...
		 <!-- Message Field -->
		  <div class="control-group">
			<label class="control-label at-icon-pen" for="inputMessage"><?php //echo $params->get('fifield_name'); ?></label>
			<div class="controls">
		...
		<?php				
		 ...
		 <!-- Submit Button -->
		  <div class="control-group-button">
			<div class="controls">
			  <button type="submit" name="sbutton" value="Send" class="at-icon-arrow-right">&nbsp;</button>

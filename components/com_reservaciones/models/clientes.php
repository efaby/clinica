 ...
 *
 */
class ReservacionesModelClientes extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__reservaciones_cliente` AS a');
		
		
		if (!JFactory::getUser()->authorise('core.edit', 'com_reservaciones'))
		{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('a.cedula like ' .$search);
			}
		}

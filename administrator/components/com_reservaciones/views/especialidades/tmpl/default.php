...
<form action="<?php echo JRoute::_('index.php?option=com_reservaciones&view=especialidades'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="especialidadList">
				<thead>
				<tr>					
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_RESERVACIONES_ESPECIALIDAD_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_RESERVACIONES_ESPECIALIDADES_NOMBRE', 'a.`nombre`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_RESERVACIONES_ESPECIALIDADES_DESCRIPCION', 'a.`descripcion`', $listDirn, $listOrder); ?>
				</th>					
				</tr>
				</thead>
				<tfoot>
				<tr>
					<td colspan="<?php echo isset($this->items[0]) ? count(get_object_vars($this->items[0])) + 1: 10; ?>">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">						
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'especialidades.', $canChange, 'cb'); ?>
							</td>
						<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_reservaciones&task=especialidad.edit&id='.(int) $item->id); ?>">

...
<form action="<?php echo JRoute::_('index.php?option=com_reservaciones&view=estados'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="estadoList">
				<thead>
				<tr>					
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_RESERVACIONES_ESTADOS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_RESERVACIONES_ESTADOS_NOMBRE', 'a.`nombre`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_RESERVACIONES_ESTADOS_DESCRIPCION', 'a.`descripcion`', $listDirn, $listOrder); ?>
				</th>					
				</tr>
				</thead>
				<tfoot>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">						
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'estados.', $canChange, 'cb'); ?>
							</td>
						<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_reservaciones&task=estado.edit&id='.(int) $item->id); ?>">

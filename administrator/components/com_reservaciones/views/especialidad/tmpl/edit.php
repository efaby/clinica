...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'especialidad.cancel') {
			Joomla.submitform(task, document.getElementById('especialidad-form'));
		}
		else {
			
			if (task != 'especialidad.cancel' && document.formvalidator.isValid(document.id('especialidad-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="especialidad-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_RESERVACIONES_TITLE_ESPECIALIDAD', true)); ?>
		<div class="row-fluid">

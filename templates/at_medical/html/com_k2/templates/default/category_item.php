...
<div class="at-blog-item catItemView group<?php echo ucfirst($this->item->itemGroup); ?> <?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="catItemBody">	
	  ...
	  <!-- Item Image -->
	    <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
	    	<div class="at-item-image-wrap"> <div class="at-item-image lazy" data-original="<?php echo htmlspecialchars($this->item->image); ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>"/> </div></div>
	    </a>
	  <div class="clr"></div>
	  <?php endif; ?>
  ...
  <?php if($this->item->params->get('catItemAttachments')): ?>
  ...
  <div class="clr"></div>
	...
	<!-- Item "read more..." link -->
	<p class="at-readmore">
		<a class="btn" href="<?php echo $this->item->link; ?>" itemprop="url">

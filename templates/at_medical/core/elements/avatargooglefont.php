		...
		else
		{
			...
			$document->addScriptDeclaration('
				...
				function clearValue(el) {
					var elID = el.id;
					var elHidden = $(elID.replace("_btn", ""));
					elHidden.set("html", "");
				}
			...
			$html[] = '<textarea class="avatar-google-font-input" rows="1" cols="30" disabled="disabled" id="'. $this->id .'" name="' . $this->name . '">'.$this->value.'</textarea>';
			$html[] = '<div class="btn" id="'.$this->id.'_btn" onclick="clearValue(this)" >Clear</div>';

...
<html lang="<?php echo $template->language; ?>" dir="<?php echo $template->direction; ?>" >
	...
	<body id="avatar-template" class="<?php echo ($this->_responsive) ? 'avatar-responsive' : 'avatar-non-responsive';?>">
		<div id="top"></div>
		...
		<div class="clearfix">
			...
			<?php if ($template->countModules('fixed-1')) : ?>
				<div class="avatar-position-stick" id="avatar-position-fixed-1">
					<jdoc:include type="modules" name="fixed-1" style="ATmodule" />
				</div>
			<?php endif; ?>
			<?php if ($template->countModules('fixed-2')) : ?>
				<div class="avatar-position-stick" id="avatar-position-fixed-2">
					<jdoc:include type="modules" name="fixed-2" style="ATmodule" />
				</div>
			<?php endif; ?>
			...
			<?php if ($posTop): ?>
				<div id="avatar-header-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_header_block'); ?>">
						<jdoc:include type="modules" name="top" style="ATmodule" />
					</div>
				</div>
			<?php endif; ?>
				...
				<div id="avatar-header-inside-block">
					...
					<?php if ($posTopLeft): ?>
						<div id="avatar-pos-top-left">
							<jdoc:include type="modules" name="top-left" style="ATmodule" />
						</div>
					<?php endif; ?>
					
					<?php if ($posTopMiddle): ?>
						<div id="avatar-pos-top-middle">
							<jdoc:include type="modules" name="top-middle" style="ATmodule" />
						</div>
					<?php endif; ?>
					
					<?php if ($posTopRight): ?>
						<div id="avatar-pos-top-right">
							<jdoc:include type="modules" name="top-right" style="ATmodule" />
						</div>
					<?php endif; ?>
			...
			<div id="avatar-tool-block">
				<div class="avatar-wrapper <?php echo $template->params->get('avatar_tool_block');?>">
					<?php if ($template->countModules('tool')): ?>
							<jdoc:include type="modules" name="tool" style="ATmodule" />
					<?php endif; ?>
				</div>
			</div>
			...
			<div id="avatar-pos-breadcrumbs">
				<div class="avatar-wrapper block-default-width">
					<div class="inner">
						<jdoc:include type="modules" name="breadcrumbs" style="ATmodule" />
					</div>
				</div>
			</div>	
			<?php endif; ?>
			...
			<?php if ($template->countModules('full-1')): ?>
				<div id="avatar-full-1-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_1_block');?>">
						<jdoc:include type="modules" name="full-1" style="ATmodule" />
					</div>
				</div>
			<?php endif; ?>
				...
				<div id="avatar-body-top-block">
						...
						<div id="avatar-promo-top">
							<?php if ($posPromoTopLeft): ?>
								<div id="avatar-pos-promo-top-left">
									<jdoc:include type="modules" name="promo-top-left" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posPromoTopMiddle): ?>
								<div id="avatar-pos-promo-top-middle">
									<jdoc:include type="modules" name="promo-top-middle" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posPromoTopRight): ?>
								<div id="avatar-pos-promo-top-right">
									<jdoc:include type="modules" name="promo-top-right" style="ATmodule" />
								</div>
							<?php endif; ?>
							<div class="clearbreak"></div>
						</div>
					...
					<?php if ($posContentTop): ?>
						<div id="avatar-pos-content-top">
							<jdoc:include type="modules" name="content-top" style="ATmodule" />
						</div>
						<div class="clearbreak"></div>
					<?php endif; ?>
						...
						<div id="avatar-user-top-col-3">
							<?php if ($posUser8): ?>
								<div id="avatar-pos-user-8">
									<jdoc:include type="modules" name="user-8" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser9): ?>
								<div id="avatar-pos-user-9">
									<jdoc:include type="modules" name="user-9" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser10): ?>
								<div id="avatar-pos-user-10">
									<jdoc:include type="modules" name="user-10" style="ATmodule" />
								</div>
							<?php endif; ?>
							<div class="clearbreak"></div>
						</div>
						...
						<div id="avatar-user-top-col-4">
							<?php if ($posUser11): ?>
								<div id="avatar-pos-user-11">
									<jdoc:include type="modules" name="user-11" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser12): ?>
								<div id="avatar-pos-user-12">
									<jdoc:include type="modules" name="user-12" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser13): ?>
								<div id="avatar-pos-user-13">
									<jdoc:include type="modules" name="user-13" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser14): ?>
								<div id="avatar-pos-user-14">
									<jdoc:include type="modules" name="user-14" style="ATmodule" />
								</div>
							<?php endif; ?>
							<div class="clearbreak"></div>
						</div>
			...
			<?php if ($template->countModules('full-2')): ?>
				<div id="avatar-full-2-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_2_block'); ?>">
						<jdoc:include type="modules" name="full-2" style="ATmodule" />
					</div>
				</div>
			<?php endif; ?>
			<?php if ($template->countModules('full-3')): ?>
				<div id="avatar-full-3-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_3_block'); ?>">
						<jdoc:include type="modules" name="full-3" style="ATmodule" />
					</div>
				</div>
			<?php endif; ?>
			<?php 
						...
						<div class="inner">
							<?php if ($posLeftTop): ?>
								<div id="avatar-pos-left-top">
									<jdoc:include type="modules" name="left-top" style="ATmodule" />
								</div>
							<?php endif; ?>
								...
								<div id="avatar-pos-left-middle">
									<?php if ($posLeftMiddle1): ?>
										<div id="avatar-pos-left-middle-1">
											<jdoc:include type="modules" name="left-middle-1" style="ATmodule" />
										</div>
									<?php endif; ?>	
									
									<?php if ($posLeftMiddle2): ?>
										<div id="avatar-pos-left-middle-2">
											<jdoc:include type="modules" name="left-middle-2" style="ATmodule" />
										</div>
									<?php endif; ?>
									<div class="clearbreak"></div>
								</div>
							...
							<?php if ($posLeftBottom): ?>
								<div id="avatar-pos-left-bottom">
									<jdoc:include type="modules" name="left-bottom" style="ATmodule" />
								</div>
							<?php endif; ?>
						</div>
					</div>
					...
					<div class="inner">
						<?php if ($template->countModules('inner-left')):?>
							<div id="avatar-pos-inner-left">
								<jdoc:include type="modules" name="inner-left" style="ATmodule" />
							</div>
						<?php endif; ?>
						...
						<div id="avatar-main-content">
							...
							<?php if ($template->countModules('banner-top')): ?>
								<div id="avatar-pos-banner-top">
									<jdoc:include type="modules" name="banner-top" style="ATmodule" />
								</div>	
							<?php endif; ?>
							
							<?php if ($template->countModules('user-top')): ?>
								<div id="avatar-pos-content-user-top">
									<jdoc:include type="modules" name="user-top" style="ATmodule" />
								</div>	
							<?php endif; ?>
								...
								<div id="avatar-content-user-top">
									<?php if ($posUser1): ?>
										<div id="avatar-pos-content-user-1">
											<jdoc:include type="modules" name="user-1" style="ATmodule" />
										</div>	
									<?php endif; ?>
									<?php if ($posUser2): ?>
										<div id="avatar-pos-content-user-2">
											<jdoc:include type="modules" name="user-2" style="ATmodule" />
										</div>	
									<?php endif; ?>
									<div class="clearbreak"></div>
								</div>
							...
							<?php if ($template->countModules('main-body-top')): ?>
								<div id="avatar-pos-main-body-top">
									<jdoc:include type="modules" name="main-body-top" style="ATmodule" />
								</div>	
							<?php endif; ?>
							...
							<?php if ($template->countModules('main-body-bottom')): ?>
								<div id="avatar-pos-main-body-bottom">
									<jdoc:include type="modules" name="main-body-bottom" style="ATmodule" />
								</div>	
							<?php endif; ?>
								...
								<div id="avatar-content-user-bottom">
									<?php if ($posUser3): ?>
										<div id="avatar-pos-content-user-3">
											<jdoc:include type="modules" name="user-3" style="ATmodule" />
										</div>	
									<?php endif; ?>
									<?php if ($posUser4): ?>
										<div id="avatar-pos-content-user-4">
											<jdoc:include type="modules" name="user-4" style="ATmodule" />
										</div>	
									<?php endif; ?>
									<div class="clearbreak"></div>
								</div>
							...
							<?php if ($template->countModules('user-bottom')): ?>
								<div id="avatar-pos-content-user-bottom">
									<jdoc:include type="modules" name="user-bottom" style="ATmodule" />
								</div>	
							<?php endif; ?>
						
							<?php if ($template->countModules('banner-bottom')): ?>
								<div id="avatar-pos-banner-bottom">
									<jdoc:include type="modules" name="banner-bottom" style="ATmodule" />
								</div>
							<?php endif; ?>
							</div>
						</div>
						...
						<?php if ($template->countModules('inner-right')):?>
							<div id="avatar-pos-inner-right">
								<jdoc:include type="modules" name="inner-right" style="ATmodule" />
							</div>
						<?php endif; ?>
						<div class="clearbreak"></div>
					</div>
						...
						<div class="inner">
							<?php if ($posRightTop): ?>
								<div id="avatar-pos-right-top">
									<jdoc:include type="modules" name="right-top" style="ATmodule" />
								</div>
							<?php endif; ?>
								...
								<div id="avatar-pos-right-middle">
									<?php if ($posRightMiddle1): ?>
										<div id="avatar-pos-right-middle-1">
											<jdoc:include type="modules" name="right-middle-1" style="ATmodule" />
										</div>
									<?php endif; ?>	
									
									<?php if ($posRightMiddle2): ?>
										<div id="avatar-pos-right-middle-2">
											<jdoc:include type="modules" name="right-middle-2" style="ATmodule" />
										</div>
									<?php endif; ?>
									<div class="clearbreak"></div>
								</div>
							...
							<?php if ($posRightBottom): ?>
								<div id="avatar-pos-right-bottom">
									<jdoc:include type="modules" name="right-bottom" style="ATmodule" />
								</div>
							<?php endif; ?>
						</div>
					</div>
			...
			<?php if ($template->countModules('full-4')): ?>
				<div id="avatar-full-4-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_4_block'); ?>">
						<jdoc:include type="modules" name="full-4" style="ATmodule" />
					</div>
				</div>
			<?php endif; ?>
			<?php if ($posPromoBottomLeft || $posPromoBottomMiddle || $posPromoBottomRight || 
			$posUser5 || $posUser6 || $posUser7 || $posUser15 || $posUser16 || $posUser17 || $posUser18 || $posContentBottom) :?>
				<div id="avatar-body-bottom-block">
					...
					<?php if ($posContentBottom): ?>
						<div id="avatar-pos-content-bottom">
							<jdoc:include type="modules" name="content-bottom" style="ATmodule" />
						</div>
					<?php endif; ?>
						...
						<div id="avatar-promo-bottom">
							<?php if ($posPromoBottomLeft): ?>
								<div id="avatar-pos-promo-bottom-left">
									<jdoc:include type="modules" name="promo-bottom-left" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posPromoBottomMiddle): ?>
								<div id="avatar-pos-promo-bottom-middle">
									<jdoc:include type="modules" name="promo-bottom-middle" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posPromoBottomRight): ?>
								<div id="avatar-pos-promo-bottom-right">
									<jdoc:include type="modules" name="promo-bottom-right" style="ATmodule" />
								</div>
							<?php endif; ?>
							<div class="clearbreak"></div>
						</div>
						...
						<div id="avatar-user-top-col-3">
							<?php if ($posUser5): ?>
								<div id="avatar-pos-user-5">
									<jdoc:include type="modules" name="user-5" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser6): ?>
								<div id="avatar-pos-user-6">
									<jdoc:include type="modules" name="user-6" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser7): ?>
								<div id="avatar-pos-user-7">
									<jdoc:include type="modules" name="user-7" style="ATmodule" />
								</div>
							<?php endif; ?>
							<div class="clearbreak"></div>
						</div>
						...
						<div id="avatar-user-bottom-col-4">
							<?php if ($posUser15): ?>
								<div id="avatar-pos-user-15">
									<jdoc:include type="modules" name="user-15" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser16): ?>
								<div id="avatar-pos-user-16">
									<jdoc:include type="modules" name="user-16" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser17): ?>
								<div id="avatar-pos-user-17">
									<jdoc:include type="modules" name="user-17" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser18): ?>
								<div id="avatar-pos-user-18">
									<jdoc:include type="modules" name="user-18" style="ATmodule" />
								</div>
							<?php endif; ?>
							<div class="clearbreak"></div>
						</div>
			...
			<?php if ($template->countModules('full-5')): ?>
				<div id="avatar-full-5-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_5_block'); ?>">
						<jdoc:include type="modules" name="full-5" style="ATmodule" />
					</div>
				</div>
			<?php endif; ?>
			<?php if ($template->countModules('full-6')): ?>
				<div id="avatar-full-6-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_full_6_block'); ?>">
						<jdoc:include type="modules" name="full-6" style="ATmodule" />
					</div>
				</div>
			<?php endif; ?>
				...
				<div id="avatar-footer-inside-block">
						...
						<div id="avatar-user-bottom-col-4">
							<?php if ($posUser19): ?>
								<div id="avatar-pos-user-19">
									<jdoc:include type="modules" name="user-19" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser20): ?>
								<div id="avatar-pos-user-20">
									<jdoc:include type="modules" name="user-20" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser21): ?>
								<div id="avatar-pos-user-21">
									<jdoc:include type="modules" name="user-21" style="ATmodule" />
								</div>
							<?php endif; ?>
							
							<?php if ($posUser22): ?>
								<div id="avatar-pos-user-22">
									<jdoc:include type="modules" name="user-22" style="ATmodule" />
								</div>
							<?php endif; ?>
							<div class="clearbreak"></div>
						</div>
					...
					<?php if ($posFooterLeft): ?>
						<div id="avatar-pos-footer-left">
							<jdoc:include type="modules" name="footer-left" style="ATmodule" />
						</div>
					<?php endif; ?>
					
					<?php if ($posFooterMiddle): ?>
						<div id="avatar-pos-footer-middle">
							<jdoc:include type="modules" name="footer-middle" style="ATmodule" />
						</div>
					<?php endif; ?>
					
					<?php if ($posFooterRight): ?>
						<div id="avatar-pos-footer-right">
							<jdoc:include type="modules" name="footer-right" style="ATmodule" />
						</div>
					<?php endif; ?>
					<div class="clearbreak"></div>
					</div>
					...
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_footer_number_block'); ?>">
						<?php if ($posFooter1): ?>
							<div id="avatar-pos-footer-number-1">
								<jdoc:include type="modules" name="footer-1" style="ATmodule" />
							</div>
						<?php endif; ?>
						<?php if ($posFooter2): ?>
							<div id="avatar-pos-footer-number-2">
								<jdoc:include type="modules" name="footer-2" style="ATmodule" />
							</div>
						<?php endif; ?>
						<?php if ($posFooter3): ?>
							<div id="avatar-pos-footer-number-3">
								<jdoc:include type="modules" name="footer-3" style="ATmodule" />
							</div>
						<?php endif; ?>
						<?php if ($posFooter4): ?>
							<div id="avatar-pos-footer-number-4">
								<jdoc:include type="modules" name="footer-4" style="ATmodule" />
							</div>
						<?php endif; ?>
						<?php if ($posFooter5): ?>
							<div id="avatar-pos-footer-number-5">
								<jdoc:include type="modules" name="footer-5" style="ATmodule" />
							</div>
						<?php endif; ?>
						<?php if ($posFooter6): ?>
							<div id="avatar-pos-footer-number-6">
								<jdoc:include type="modules" name="footer-6" style="ATmodule" />
							</div>
						<?php endif; ?>
						<div class="clearbreak"></div>
					</div>
			...
			<?php if ($posFooter): ?>
				<div id="avatar-footer-block">
					<div class="avatar-wrapper <?php echo $template->params->get('avatar_footer_block'); ?>">
						<jdoc:include type="modules" name="footer" style="ATmodule" />
					</div>
				</div>
			<?php endif; ?>
